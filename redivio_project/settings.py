...
MIDDLEWARE = [
    ...
    "django.middleware.locale.LocaleMiddleware",  # ✅ مضاف لتحويل اللغة
...
TIME_ZONE = "UTC"
USE_I18N = True
USE_L10N = True  # تفعيل التنسيقات المحلية (التاريخ والأرقام)
USE_TZ = True
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ahmed.abass.21@gmail.com'  # بريدك الإلكتروني الذي سترسل منه
EMAIL_HOST_PASSWORD = 'gmzp uppm wxgu rmbb'  # كلمة مرور التطبيق (وليس الباسورد العادي في حالة Gmail)
DEFAULT_FROM_EMAIL = 'Redivio ERP'